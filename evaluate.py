...
def main():
    type_hierarchy, max_depth = load_type_hierarchy('Evaluation/dbpedia_types.tsv')
    ground_truth = load_ground_truth('data/smarttask_dbpedia_test.json', type_hierarchy)
    system_output = load_system_output('Results/system_output_json.json')
